...
for r in range(1100):
    ...
    pd.DataFrame(q_list).to_csv('./corona/corona_omi/q_list.csv')
    pd.DataFrame(seiq_matrix[start:end+1,]).to_csv('./corona/corona_omi/seiq_matrix.csv')
    pd.DataFrame(suscept).to_csv('./corona/corona_omi/suscept.csv')
    pd.DataFrame(exposed).to_csv('./corona/corona_omi/exposed.csv')
    pd.DataFrame(I_total).to_csv('./corona/corona_omi/I_total.csv')
