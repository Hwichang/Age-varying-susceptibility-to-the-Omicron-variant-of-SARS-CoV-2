...
vaccine_omi = read.csv('vaccinated_omi_220421.csv')
...
vaccine_res[100:110,1] = '75세 이상'
############## 60-70 #########################################

AZ_1 = vaccine_res %>% filter(X.1=='AZ' & X.2 =='1차')

AZ_2 = vaccine_res %>% filter(X.1=='AZ' & (X.2 =='2차' |X.2 == '2차 ') )

AZ_3 = vaccine_res %>% filter(X.1=='AZ' & (X.2 =='3차' |X.2 == '3차 ') )

PF_1 = vaccine_res %>% filter(X.1=='P' & X.2 =='1차')

PF_2 = vaccine_res %>% filter(X.1=='P' & (X.2 =='2차'))

PF_3 = vaccine_res %>% filter(X.1=='P' & (X.2 =='3차'))

M_1 = vaccine_res %>% filter(X.1=='M' & X.2 =='1차')

M_2 = vaccine_res %>% filter(X.1=='M' & (X.2 =='2차'))

M_3 = vaccine_res %>% filter(X.1=='M' & (X.2 =='3차'))


JJ_1 = vaccine_res %>% filter(X.1=='JJ' & (X.2 =='1차'))
JJ_3 = vaccine_res %>% filter(X.1=='JJ' & (X.2 =='3차'))
